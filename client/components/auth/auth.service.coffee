...
.factory 'Auth', ($location, $rootScope, $http, User, UserPass, $cookieStore, $q) ->
  ...
  @return {Promise}
  ###
  changeDetail: (username, country, address, gender, surname, mobilePhone, city, postalCode, contactPhone, callback) ->
    User.changeDetail
      id: currentUser._id
    ,
      username: username
